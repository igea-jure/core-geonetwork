...
<xsl:stylesheet xmlns:gmd="http://www.isotc211.org/2005/gmd"
  ...
  <xsl:template match="*" mode="metadata">
    ...
    <xsl:for-each select="gmd:identificationInfo//gmd:MD_DataIdentification|
      ...
      <xsl:for-each select="gmd:resourceMaintenance/
                            gmd:MD_MaintenanceInformation/gmd:maintenanceNote/gco:CharacterString">
      ...
      <xsl:for-each select="gmd:resourceConstraints/*">
        ...
        <xsl:for-each select="current()[gmd:useConstraints]/gmd:otherConstraints/gco:CharacterString/text()">
          <Field name="{$fieldPrefix}UseConstraints"
